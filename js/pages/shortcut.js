const shortcut = {
    ...
    methods: {
        gotoLogin() {
            window.location = "http://10.45.50.241/login.html?returnUrl=" + window.location;
        },
        gotoRegister(){
            window.location = "http://10.45.50.241/register.html";
        },
        gotoHome(){
            window.location = "http://10.45.50.241/home.html";
        }
    }
}
